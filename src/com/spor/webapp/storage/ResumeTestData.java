...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.setContacts(PHONE, new ContactData("+7(921) 855-0482", ""));
        resume.setContacts(SKYPE, new ContactData("grigory.kislin", "skype:grigory.kislin"));
        resume.setContacts(MAIL, new ContactData("gkislin@yandex.ru", "mailto:gkislin@yandex.ru"));
        resume.setContacts(PROFILE, new ContactData("LinkedIn", "https://www.linkedin.com/in/gkislin"));
        resume.setContacts(PROFILE, new ContactData("GitHub", "https://github.com/gkislin"));
        resume.setContacts(PROFILE, new ContactData("StackOverflow", "https://stackoverflow.com/users/548473"));
        resume.setContacts(LINK, new ContactData("Домашняя страница", "http://gkislin.ru/"));
        ...
        resume.setSections(ACHIEVEMENT, new ListTextSection(achievements));
        ...
        resume.setSections(QUALIFICATIONS, new ListTextSection(qualifications));

        List<Data> experience = new ArrayList<>();
        experience.add(new Data(
        ...
        resume.setSections(EXPERIENCE, new ListDataSection(experience));

        List<Data> education = new ArrayList<>();
        education.add(new Data(
